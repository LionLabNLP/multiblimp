...
if __name__=="__main__":
    ...
    parser.add_argument("--target_id", default=None,
                        help="Override the output dir name (decision_trees/<id>, "
                             ...
                             "filename (iovGa). Useful for A/B runs that shouldn't "
    ...
    # indexing) -- see iovNa.py's comment and
    # word_order.prediction_target.iobj_agr_target's docstring. Gender is
    # the rarest of the three indirect-object-agreement dimensions in the
    # UD languages that mark this at all -- expect low candidate counts
    # even where present.
    ...
    pipeline = Pipeline(target=target,
                        ...
                        inflection_map=swap_gender_iobj_any,
                        unimorph_args = {
                            "filter_entries": {
                                "upos": ["V"],
                                },
